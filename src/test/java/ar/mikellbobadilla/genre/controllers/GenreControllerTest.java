package ar.mikellbobadilla.genre.controllers;
...
class GenreControllerTest {
    ...
    void testCreateGenre() throws Exception {
        CreateGenreDTO createGenreDTO = new CreateGenreDTO("acción");
        String requestBody = objectMapper.writeValueAsString(createGenreDTO);
    ...
    void testBadCreateGenre() throws Exception {
        CreateGenreDTO createGenreDTO = new CreateGenreDTO("1231!@##");
        String requestBody = objectMapper.writeValueAsString(createGenreDTO);
